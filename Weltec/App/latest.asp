...
function read_to_file() // reads to file latest
{
...
var filename="latest.txt";// application file
...
function read_to_file_append()
{
//This function reads the content of client form to a disk file
...
<div id="navigation"><div><a href="default.html">Home</a></div><div><a href="application_submit.html">Submit</a></div><div><a href="latest.asp">Latest</a></div><div><a href="#">Database</a></div><div><a href="JavaScript:wind2()">Help</a></div></div>

<form>
<table width="700px" border="0" cellspacing="2" cellpadding="2" bgColor="#6699FF" align="center">
  <tr>
    <td colspan="4"><img src="logo.gif"><h1>Latest - Sorry Results Unavaliable -</h1> will be avaliable soon !
<p>Here are the latest results<br>
Check below:
</p><br></td>
  </tr>
  <tr>
